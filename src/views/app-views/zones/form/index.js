...
import {GOOGLE_MAPS_API_KEY, WEB_CONFIG} from "configs/AppConfig";
import GoogleMapReact from 'google-map-react';

const { Option } = Select;

export class ZoneForm extends Component {
            ...
            <Card title="Basic Info" bordered={this.props.bordered}>
              <Row>
                    ...
                    <Col xs={24} sm={24} md={24}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: 'Please input a name for this zone',
                          },
                        ]}
                      >
                        <Input/>
                    ...
                    <Col xs={24} sm={24} md={12}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: 'Please choose the main district',
                          },
                        ]}
                      >
                ...
                <Col xs={24} sm={24} md={24} lg={24}>
                  ...
                  >
                    <Input.TextArea rows={8} placeholder="Type description about this zone..."/>
                  </Form.Item>
                </Col>
              </Row>
            </Card>
